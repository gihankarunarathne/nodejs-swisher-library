 ...
 * }
 */
Notification.prototype.sendMessagesToRecipients = function (recipients, msg, optional, callback) {
  ...
  if (optional.hasOwnProperty("deliverOffline")) req.deliverOffline = optional.deliverOffline;
 ...
 * }
 */
Notification.prototype.sendMessagesToChannel = function (channel, msg, optional, callback) {
  if (D) console.log("Notification send .... ");
  var self = this;
  var req = {
    channel : channel,
