 ...
 * @param subject
 * @param message
 * @param options Pass optional BCC or CC or Empty Object as {}
 ...
 * }
 */
Email.prototype.send = function (to, from, subject, message, options, callback) {
  ...
  if (Object.hasAttribute("bcc")) req.bcc = options.bcc;
  if (Object.hasAttribute("cc")) req.cc = options.cc;
